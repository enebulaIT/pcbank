                    ...
                    <div className="row justify-content-center">
                        ...
                        <div className="col-lg-3 col-md-6">
                            <div className="single-work mt-md-0 text-center">
                                ...
                                <h5><Link className="initiate-scripts" to={'/machinery-loan'}>Business Loan</Link></h5>
                                <p>Shree Parswanath Co-op Bank Ltd provides Business Loan Facility</p>
                                <Link className="angle-btn initiate-scripts" to={'/machinery-loan'}><img src={process.env.PUBLIC_URL + '/assets/img/icon/angle-left-round.png'} alt="icon" /></Link>
                            </div>
                        </div>
                        <div className="col-lg-3 col-md-6">
                            <div className="single-work text-center">
                                ...
                                <h5><Link className="initiate-scripts" to={'/fixed-deposit'}>Deposits</Link></h5>
                                <p>Shree Parswanath Co-op Bank Ltd provides Deposits Facility.</p>
                                <Link className="angle-btn initiate-scripts" to={'/fixed-deposit'}><img src={process.env.PUBLIC_URL + '/assets/img/icon/angle-left-round.png'} alt="icon" /></Link>
                            </div>
                        </div>
                    </div>
                </div>
