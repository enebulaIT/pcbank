                    ...
                    <div className="row justify-content-center">
                        <div className="col-lg-3 col-md-6">
                            <div className="single-work mt-0 text-center">
                                <div className="work-icon">
                                    <img className="" src={process.env.PUBLIC_URL + '/assets/img/work/01.png'} alt="icon" />
                                </div>
                        ...
                        <div className="col-lg-3 col-md-6">
                            <div className="single-work mt-md-0 text-center">
                                <div className="work-icon">
                                    <img className="" src={process.env.PUBLIC_URL + '/assets/img/work/02.png'} alt="icon" />
                                </div>
                        ...
                        <div className="col-lg-3 col-md-6">
                            <div className="single-work text-center">
                                <div className="work-icon">
                                    <img className="" src={process.env.PUBLIC_URL + '/assets/img/work/03.png'} alt="icon" />
                                </div>
                                <h5><Link className=" initiate-scripts" to={'/services'}>Start Invest</Link></h5>
                                <p>Lorem ipsum dolor sit amet, consectetur</p>
                                <Link className="angle-btn" to={'/services'}><img src={process.env.PUBLIC_URL + '/assets/img/icon/angle-left-round.png'} alt="icon" /></Link>
                            </div>
                        </div>
                        <div className="col-lg-3 col-md-6">
                            <div className="single-work text-center">
                                <div className="work-icon">
                                    <img className="" src={process.env.PUBLIC_URL + '/assets/img/work/04.png'} alt="icon" />
                                </div>
