                            ...
                            <div className="col-lg-8 posts-list">
                                <div className="single-post">
                                    <div className="feature-img">
                                        <img className="img-fluid" src={process.env.PUBLIC_URL + '/assets/img/blog/single_blog_1.png'} alt="img" />
                                    </div>
                                    ...
                                    <div className="navigation-area">
                                        <div className="row">
                                            <div
                                                ...
                                                <div className="thumb">
                                                    <Link className="initiate-scripts" to={'/blog-single'}>
                                                        <img className="img-fluid" src={process.env.PUBLIC_URL + '/assets/img/post/preview.png'} alt="img" />
                                                    </Link>
                                                </div>
                                                <div className="arrow">
                                                    <Link className="initiate-scripts" to={'/blog-single'}>
                                            ...
                                            <div
                                                ...
                                                <div className="thumb">
                                                    <Link className="initiate-scripts" to={'/blog-single'}>
                                                        <img className="img-fluid" src={process.env.PUBLIC_URL + '/assets/img/post/next.png'} alt="img" />
                                                    </Link>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div className="blog-author">
                                    <div className="media align-items-center">
                                        <img src={process.env.PUBLIC_URL + '/assets/img/blog/author.png'} alt="img" />
                                ...
                                <div className="comments-area">
                                    ...
                                    <div className="comment-list">
                                        <div className="single-comment justify-content-between d-flex">
                                            <div className="user justify-content-between d-flex">
                                                <div className="thumb">
                                                    <img src={process.env.PUBLIC_URL + '/assets/img/comment/comment_1.png'} alt="img" />
                                                </div>
                                                <div className="desc">
                                    ...
                                    <div className="comment-list">
                                        <div className="single-comment justify-content-between d-flex">
                                            <div className="user justify-content-between d-flex">
                                                <div className="thumb">
                                                    <img src={process.env.PUBLIC_URL + '/assets/img/comment/comment_2.png'} alt="img" />
                                                </div>
                                                <div className="desc">
                                                    <p className="comment">Multiply sea night grass fourth day sea lesser rule open subdue female fill which them Blessed, give fill lesser bearing multiply sea night grass fourth day sea lesser</p>
                                                    <div className="d-flex justify-content-between">
                                    ...
                                    <div className="comment-list">
                                        <div className="single-comment justify-content-between d-flex">
                                            <div className="user justify-content-between d-flex">
                                                <div className="thumb">
                                                    <img src={process.env.PUBLIC_URL + '/assets/img/comment/comment_3.png'} alt="img" />
                                                </div>
                                                <div className="desc">
                                                    <p className="comment">Multiply sea night grass fourth day sea lesser rule open subdue female fill which them Blessed, give fill lesser bearing multiply sea night grass fourth day sea lesser</p>
                                                    <div className="d-flex justify-content-between">
