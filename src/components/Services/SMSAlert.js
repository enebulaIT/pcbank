                                ...
                                <div className="single-post">
                                    <div className="blog_details">
                                        ...
                                        <ul>
                                            ...
                                            <li>
                                                Shree Parswanath Bank SMS Alert is a service that allows you to stay updated on your banking transactions on Shree Parswanath Bank&nbsp;account on your mobile. These alerts could be event based.</li>
                                            <li>
                                            ...
                                            <li>
                                                Your mobile number should be registered with Shree Parswanath Bank.</li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
